...
public class AsterixConn {
    ...
    private static InputStream executeHttpMethod(HttpMethod method) {
        ...
        try {
            ...
            if (statusCodes != HttpStatus.SC_OK) {
                GlobalConfig.ASTERIX_LOGGER.log(Level.SEVERE, "Method failed: " + method.getStatusCode());
            }
    ...
    private String processSyncAQL(AsterixConf conf, AsterixConf.OpType type, String reqStr) throws Exception {
        ...
        if (HttpStatus.SC_OK != ret) {
            GlobalConfig.ASTERIX_LOGGER.log(Level.SEVERE, "Method failed: " + post.getStatusCode());
            String[] errors = null;
            try {
